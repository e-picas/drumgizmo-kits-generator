...
class TestDrumGizmoKitGenerator(unittest.TestCase):
    ...
    def test_prepare_metadata(self):
        ...
        self.assertEqual(metadata['description'], 'This is a description', "Description should match command line arg")
        self.assertIn('DrumGizmo kit generated for testing purpose', metadata['notes'], "Notes should be read from config")
        ...
        self.assertEqual(metadata['website'], 'http://example.com', "Website should be read from config")
        ...
        self.assertEqual(metadata['description'], 'Command line description', "Description should be from command line")
        self.assertIn('Command line notes', metadata['notes'], "Notes should be from command line")
        self.assertEqual(metadata['author'], 'Command Line Author', "Author should be from command line")
        self.assertEqual(metadata['license'], 'Command Line License', "License should be from command line")
        self.assertEqual(metadata['samplerate'], '96000', "Sample rate should be from command line")
        self.assertEqual(metadata['instrument_prefix'], 'CL', "Instrument prefix should be from command line")
